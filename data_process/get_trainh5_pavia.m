clear;close all;
%% settings
foldertrain = './cat_LHS_PAN/I_predLHSpa_Pan/train_17Hin';
folderlabel='./Respavia_lhsconv/label_17Hres';
size_input=32;
size_label=32;
stride =16;

savepath = 'train_predLHSpaPanMapRes.h5';
filepaths1 = dir(fullfile(foldertrain,'*.mat'));
filepaths2 = dir(fullfile(folderlabel,'*.mat'));

%% initialization
data = zeros(size_input, size_input, 103, 1);
...
for i=1:length(filepaths1)
    ...
    image_train = imgt.predLHSpa_Pan;
    image_label = imgl.I_respa;
